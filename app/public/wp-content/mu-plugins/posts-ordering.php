...
class Hicpo
{
	...
	function load_script_css()
	{
		if ( $this->_check_load_script_css() ) {
			...
			wp_enqueue_script( 'posts-ordering-js', get_template_directory_uri().'/../../mu-plugins/posts-ordering.min.js', array( 'jquery' ), null, true );
			wp_enqueue_style( 'posts-ordering-css', get_template_directory_uri().'/../../mu-plugins/posts-ordering.min.css', array(), null );
		}
	}
