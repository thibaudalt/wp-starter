...
add_filter( 'admin_footer_text', function() {
	return '© Copyright '.date("Y").' - Site web par <a href="https://web-tailor.ch/" title="Web Tailor" target="_blank">Web Tailor</a>';
});
...
add_action( 'wp_dashboard_setup', function() {
	wp_add_dashboard_widget( 'ws_summary_dashboard_widget', 'Web Tailor', function() {
		echo '<table style="width:100%">'
				.'<tr><td>Web Tailor<br>Côtes-de-Montbenon 30<br>CH-1003 Lausanne / VD</td>'
				.'<td>Mail : <a title="Web Tailor" href="mailto:support@web-tailor.ch">support@web-tailor.ch</a><br>'
